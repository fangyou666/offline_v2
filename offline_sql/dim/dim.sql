...
insert overwrite table dim_sku_full partition(dt=20250916)
select
    sku.id,
    sku.price,
    sku.sku_name,
...
insert overwrite table dim_coupon_full partition(dt=20250916)
select
    id,
    coupon_name,
    coupon_type,
...
insert overwrite table dim_user_zip partition (dt = 20250916)
select id,
